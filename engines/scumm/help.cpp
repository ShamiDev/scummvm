...
HelpDialog::HelpDialog()
  ...
  // Common Controls (page 1)
  static const char * const commonTabs[] = {
	_s("Common"),
	"",
    _s(
    "## Common Controls\n"
    "\n"
    "This section details common keybinds applicable across most games.\n"
    "\n"
    "| Command | Action |\n"
    "|---|---|\n"
    "| `F5` | Save / Load Dialog\n"
    ...
    "| `Esc` | Skip cutscene\n"
    "| `Space` | Pause game\n"
    "| `Ctrl 0-9` | Load saved game 1-10\n"
    "| `Alt` | Save game 1-10\n"
    "| `Alt x, Ctrl z` | Quit\n"
    "| `Alt Enter` | Toggle fullscreen\n"
    "| `[, ]` | Music volume up / down\n"
    "| `-, +` | Text speed slower / faster\n"
    "| `Enter` | Simulate left mouse button\n"
    "| `Tab` | Simulate right mouse button\n"
	),
	0,
  };

  // Specific Controls (page 2)
  static const char * const specialTabs[] = {
	_s("Special"),
	"",
	_s(
	"## Special Controls\n"
	...
	"| Command | Action |\n"
	"|---|---|\n"
	"| `Ctrl d` | Start the debugger\n"
	"| `Ctrl s` | Show memory consumption\n"
	"| `Ctrl f` | Run in fast mode (*)\n"
	"| `Ctrl g` | Run in fast mode (*)\n"
	"| `Ctrl m` | Toggle mouse capture\n"
	"| `Ctrl Alt 1-8` | Switch between graphics filters\n"
	"| `Ctrl Alt +, -` | Increase / Decrease scale factor\n"
	...
	"  or incorrect game behaviour.\n"
	),
	0,
  };

  // ... (Replace with similar Markdown table for game-specific controls)

  // ... (Repeat for other pages based on your existing logic)

  addTabs(commonTabs /* ... additional tab content ... */ );
  addTabs(specialTabs);
  _tab->setActiveTab(0);
...
// Common::U32String createMarkdownRow(const Common::U32String& key, const Common::U32String& description, bool newline = true) {
//   return _("| ") + key + _(" | ") + description + _(" |\n") + (newline ? "\n" : "");
// 	}
